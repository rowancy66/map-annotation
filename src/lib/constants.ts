// 天地图配置
export const TIANDITU_KEY = process.env.NEXT_PUBLIC_TIANDITU_KEY?.trim() || '';
export const HAS_TIANDITU_KEY = TIANDITU_KEY.length > 0;

// 天地图瓦片服务 URL 模板
export const TIANDITU_LAYERS = HAS_TIANDITU_KEY
  ? {
      // 矢量底图
